...
urlpatterns = [
    ...
    url(r'^frameworks/(?P<market_name>[\w-]+)/(?P<strategy_name>[\w_-|\W]+)/(?P<delete_element>[\w_-|\W]*)/(?P<type>[\w]+)/$', views.frameworks_with_delete_element, name='frameworks_delete_element'),
